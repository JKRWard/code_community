...
???
Topic model uses descriptions - prone to human bias
-can get other measurements such as leaf area index - gives an idea of density of vegetation - is animal exposed to predators or not
